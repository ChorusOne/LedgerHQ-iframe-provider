...
var IFrameEthereumProvider = /*#__PURE__*/ (function(_EventEmitter) {
  ...
  function IFrameEthereumProvider(_temp) {
    ...
    var _ref = _temp === void 0 ? {} : _temp,
      ...
      targetOrigin =
        _ref$targetOrigin === void 0
          ? DEFAULT_TARGET_ORIGIN
          : _ref$targetOrigin,
      _ref$timeoutMilliseco = _ref.timeoutMilliseconds,
      timeoutMilliseconds =
        _ref$timeoutMilliseco === void 0
          ? DEFAULT_TIMEOUT_MILLISECONDS
          : _ref$timeoutMilliseco,
      ...
      eventTarget =
        _ref$eventTarget === void 0 ? window.parent : _ref$eventTarget;
    ...
    _this2.eventSource.addEventListener(
      'message',
      _this2.handleEventSourceMessage
    );
  ...
  _proto.request = function request(_ref2) {
    ...
    try {
      ...
      return Promise.resolve(_this6.execute(method, params)).then(function(
        response
      ) {
  ...
  _proto.send = function send(method, params) {
    try {
      ...
      return Promise.resolve(_this8.execute(method, params)).then(function(
        response
      ) {
        if ('error' in response) {
          throw new RpcError(response.error.code, response.error.message);
  ...
  _proto.enable = function enable() {
    try {
      ...
      if (_this10.enabled === null) {
        var promise = (_this10.enabled = _this10
          .send('enable')
          ['catch'](function(error) {
            ...
            if (_this10.enabled === promise) {
              _this10.enabled = null;
            } // Rethrow the error.
      ...
      return Promise.resolve(_this10.enabled);
    } catch (e) {
      return Promise.reject(e);
    }
  };
  ...
  _proto.sendAsync = function sendAsync(payload, callback) {
    try {
      ...
      var _temp3 = _catch(
        function() {
          return Promise.resolve(
            _this12.execute(payload.method, payload.params, payload.id)
      ...
      return Promise.resolve(
        _temp3 && _temp3.then ? _temp3.then(function() {}) : void 0
      );
    } catch (e) {
      return Promise.reject(e);
    }
